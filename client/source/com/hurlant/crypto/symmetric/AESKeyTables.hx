...
import haxe.Int32;
class AESKeyTables {
    public static var _Sbox:Array<Int32> = [ // forward s-box
    ...
    public static var _InvSbox:Array<Int32> = [ // inverse s-box
    ...
    public static var _Xtime2Sbox:Array<Int32> = [ // combined Xtimes2[Sbox[]]
    ...
    public static var _Xtime3Sbox:Array<Int32> = [ // combined Xtimes3[Sbox[]]
    ...
    // Xtime3[x] = x^Xtime2[x];
    public static var _Xtime2:Array<Int32> = [
    ...
    public static var _Xtime9:Array<Int32> = [
    ...
    public static var _XtimeB:Array<Int32> = [
    ...
    public static var _XtimeD:Array<Int32> = [
    ...
    public static var _XtimeE:Array<Int32> = [
    ...
    public static var _Rcon:Array<Int32> = [0x00, 0x01, 0x02, 0x04, 0x08, 0x10, 0x20, 0x40, 0x80, 0x1b, 0x36];
